...
def parse_args():
    ...
    parser.add_argument(
        "--save-erf-matrix", default=None, type=str, help="path to the contribution score matrix (.npy file)"
    )
...
def process(args):
    ...
    data_loader_val = torch.utils.data.DataLoader(
        dataset, sampler=sampler_val, batch_size=1, num_workers=1, pin_memory=True, drop_last=False
    )
