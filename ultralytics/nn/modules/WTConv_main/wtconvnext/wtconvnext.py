...
class WTConvNeXtBlock(nn.Module):
    """WTConvNeXt Block There are two equivalent implementations: (1) DwConv -> LayerNorm (channels_first) -> 1x1 Conv
...
class WTConvNeXt(nn.Module):
    r"""WTConvNeXt Based on a PyTorch impl of : `A ConvNet for the 2020s` - https://arxiv.org/pdf/2201.03545.pdf.
    """
    ...
    def prune_intermediate_layers(
        self,
        indices: int | list[int] | tuple[int] = 1,
