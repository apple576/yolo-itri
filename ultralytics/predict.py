...
if __name__ == '__main__':
    ...
    MODEL_WEIGHTS = r'C:\Users\user\Desktop\best(1).pt' # 模型權重路徑
    OUTPUT_FOLDER = r'C:\Users\user\Desktop\comparison_results_RBBM'   # 想要儲存結果的資料夾名稱
    # ==============================================
    ...
    # 1. 指定「單張圖片」的完整路徑
    IMG_PATH = r'C:\Users\user\Downloads\dataset\val\images\Japan_000117.jpg' 
